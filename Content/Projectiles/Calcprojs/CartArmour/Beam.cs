...
namespace TheSkeletronMod.Content.Projectiles.Calcprojs.CartArmour
{
    public class Beam : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            laser(spriteBatch, texture, new Vector2(p.GetModPlayer<SkeletronPlayer>().proj.position.X, p.GetModPlayer<SkeletronPlayer>().proj.position.Y),
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            float point = 0f;
            return Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), player.GetModPlayer<SkeletronPlayer>().proj.Center,
                player.GetModPlayer<SkeletronPlayer>().proj.Center + unit * setting, 22, ref point);
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 10)
            {
                ...
                {
                    difference = player.GetModPlayer<SkeletronPlayer>().npc.Center - player.GetModPlayer<SkeletronPlayer>().proj.Center;
            ...
            Projectile.direction = player.GetModPlayer<SkeletronPlayer>().npc.Center.X > player.GetModPlayer<SkeletronPlayer>().proj.Center.X ? 1 : -1;
            ...
            Projectile.position = player.GetModPlayer<SkeletronPlayer>().proj.Center + Projectile.velocity * moving;
        }
