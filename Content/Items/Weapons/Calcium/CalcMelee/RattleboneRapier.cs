...
namespace TheSkeletronMod.Content.Items.Weapons.Calcium.CalcMelee
{
    ...
    public class RattleboneRapier : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.ItemSetDefault(84, 75, 11, 2.5f, 6, 18, ItemUseStyleID.Rapier, false);
            Item.channel = true;
        }
    ...
    public class RattleboneRapierProj : ModProjectile
    {
        ...
        //how the fuck you can add heart here ? - Xinim
        public override void SetDefaults()
        {
        ...
        public const float Projectile_Length = 220f;
        ...
        {
            Vector2 end = Projectile.Center + Projectile.velocity.SafeNormalize(Vector2.UnitX) * Projectile_Length * Projectile.scale;
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            {
                float num9 = Utils.Remap(i, 0f, 1f, 1f, 5f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.instance.LoadItem(ModContent.ItemType<RattleboneRapier>());
            int num3 = 2;
            ...
            Texture2D value = TextureAssets.Item[ModContent.ItemType<RattleboneRapier>()].Value;
            Vector2 origin = value.Size() * .5f;
            ...
            float num9 = num8 + MathHelper.PiOver4;
