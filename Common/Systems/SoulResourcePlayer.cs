...
{
    public class SoulResourcePlayer : ModPlayer
    {
        // Here we create a custom resource, similar to mana or health.
        // Creating some variables to define the current value of our example resource as well as the current maximum value. We also include a temporary max value, as well as some variables to handle the natural regeneration of this resource.
        public int SoulResourceCurrent; // Current value of our example resource
        public const int DefaultSoulResourceMax = 200; // Default maximum value of example resource
        public int SoulResourceMax; // Buffer variable that is used to reset maximum resource to default value in ResetDefaults().
        public int SoulResourceMax2; // Maximum amount of our example resource. We will change that variable to increase maximum amount of our resource
        public float SoulResourceRegenRate; // By changing that variable we can increase/decrease regeneration rate of our resource
        internal int SoulResourceRegenTimer = 0; // A variable that is required for our timer
        public static readonly Color HealSoulResource = new(187, 91, 201); // We can use this for CombatText, if you create an item that replenishes exampleResourceCurrent.
        ...
        private void UpdateResource()
        {
            ...
            if (SoulResourceRegenTimer > 60 / SoulResourceRegenRate)
            {
        ...
        private void CapResourceGodMode()
        {
            ...
            {
                SoulResourceCurrent = SoulResourceMax2;
            }
        }
    }
}
