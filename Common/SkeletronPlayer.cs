...
using TheSkeletronMod.Content.Items.Accessories.PendantTree;

namespace TheSkeletronMod.Common
{
    public class SkeletronPlayer : ModPlayer
    {
        ...
        public override IEnumerable<Item> AddStartingItems(bool mediumCoreDeath)
        {
            ...
            return new Item[]
            {
                new (ModContent.ItemType<CranialPendant>(), 1, 0),
            };
        }
        ...
        {
            cc = Terraria.Utils.Clamp(cc, 0, ccMM);
        }
